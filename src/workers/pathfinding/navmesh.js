...
export function generateNavMesh(paths) {
...
export function shrinkPaths(paths, radius) {
...
export function wallsToPaths(walls) {
...
function pathsToMultiPolygon(paths) {
...
function indicesToTriangles(triangleIndices, polyData) {
  const triangles = [];
